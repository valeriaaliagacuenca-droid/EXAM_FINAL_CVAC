...
map.getView().fit([-8051656.718322, -1910750.847476, -7867651.905247, -1788896.442228], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mapa de la provincia de Arequipa</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (92 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Mapa Web elaborado en el curso de SIG, por Ing. Cristina Valeria Aliaga Cuenca<br />Ciclo 2025-II';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_Distriros_prov_Arequipa_4,
    colName: 'NOMBDIST',
    zoom: 10,
    collapsed: true,
    map: map,
